...
BuildRequires:      libnaviutil >= 0.1.1, libnaviutil-devel >= 0.1.1
Requires:           pcre,openssl,gd
Requires:           libnaviutil >= 0.1.1
...
%{__install} -p -D -m 0755 %{_builddir}/nginx-%{version}/nginx_navi_mod/conf/restapi.conf %{buildroot}%{nginx_confdir}/conf.d
