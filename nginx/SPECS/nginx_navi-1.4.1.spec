...
BuildRequires:      libcnavi = 0.5.1, libcnavi-devel = 0.5.1, libcnavi-driver = 0.5.1, libcnavi-driver-devel = 0.5.1 
Requires:           pcre,openssl,gd
Requires:           libcnavi = 0.5.1, libcnavi-driver = 0.5.1
