...
BuildRequires:      pcre-devel,openssl-devel,perl(ExtUtils::Embed)
BuildRequires:      libxslt-devel,gd-devel
BuildRequires:      libcnavi >= 0.6.0, libcnavi-devel >= 0.6.0, libcnavi-driver >= 0.6.0, libcnavi-driver-devel >= 0.6.0 
BuildRequires: gperftools >= 2.0, gperftools-devel >= 2.0
Requires: gperftools >= 2.0
Requires:           pcre,openssl,gd
Requires:           libcnavi >= 0.6.0 libcnavi-driver >= 0.6.0
...
Source103:  50x.html
Source104:  404.html
Source105:  nginx_navi_mod.tar.gz
Source106:  nginx_upload_module.tar.gz
Source107:  nginx-rtmp-module.tar.gz
Source108:	ngx_http_qrcode_module.tar.gz
...
# etc.
#Patch1:     nginx-config-%{version}.patch
...
#%patch1 -p0
%{__tar} zxvf %{SOURCE5}
%{__tar} zxvf %{SOURCE105}
%{__tar} zxvf %{SOURCE106}
%{__tar} zxvf %{SOURCE107}
%{__tar} zxvf %{SOURCE108}
...
./configure \
    ...
    --add-module=%{_builddir}/nginx-%{version}/nginx_upload_module \
    --add-module=%{_builddir}/nginx-%{version}/nginx_navi_mod \
    --add-module=%{_builddir}/nginx-%{version}/nginx-rtmp-module\
    --add-module=%{_builddir}/nginx-%{version}/ngx_http_qrcode_module
make %{?_smp_mflags} 
...
%{__install} -p -D -m 0755 %{_builddir}/nginx-%{version}/nginx_navi_mod/conf/cnavi.conf %{buildroot}%{nginx_confdir}/conf.d
%{__install} -p -D -m 0755 %{_builddir}/nginx-%{version}/nginx_navi_mod/conf/cnavi_addition_locs %{buildroot}%{nginx_confdir}/conf.d
...
%config(noreplace) %{nginx_confdir}/conf.d/cnavi_addition_locs
...
%changelog
* Wed Nov 13 2013 Jack Peng <pengjinzhen@youku.com> - 1.4.1-1
- update to 1.4.1-1

* Wed May 23 2012 Jack Peng <pengjinzhen@youku.com> - 1.0.12-1
- add module : nginx_navi_mod

* Mon Feb 06 2012 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.12-1
- update to 1.0.12-1

* Fri Dec 16 2011 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.11-1
- update to 1.0.11-1

* Wed Nov 16 2011 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.10-1
- update to 1.0.10-1

* Fri Nov 04 2011 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.9-1
- update to 1.0.9-1

* Sun Oct 03 2011 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.8-2
- update to 1.0.8-2

* Sat Oct 01 2011 Denis Frolov <d.frolov81 at mail dot ru> - 1.0.8-1
- rebuild to 1.0.8
